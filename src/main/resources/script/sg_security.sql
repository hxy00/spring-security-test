...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '新增', 'add', NULL, '0', '0', 'add', '#', NULL, NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_menu` VALUES (2, '删除', 'del', NULL, '0', '0', 'del', '#', NULL, NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_menu` VALUES (3, '修改', 'update', NULL, '0', '0', 'update', '#', NULL, NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_menu` VALUES (4, '查询', 'query', NULL, '0', '0', 'query', '#', NULL, NULL, NULL, NULL, 0, NULL);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, 'test', 'test', '0', 0, NULL, NULL, NULL, NULL, NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (3, 'admin', 'admin', '$2a$10$bRmQxrYJieZ9L/JDa1FpleAon.UXusMNbyFLaAGF6OIBHtR3rlgOO', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
